...
@section('content')
    ...
    <table align="center" class="ord_index">
        <th class="ord_th" id="product_th">주문 번호</th>
        <th class="ord_th" id="send_user_th">받는 사람</th>
        <th class="ord_th" id="send_address_th">주문 제품</th>
        <th class="ord_th" id="order_date_th">구매 날짜</th>
        <th class="ord_th" id="order_th">확인/신청</th>
        @forelse($orders as $order)
            <tr class="order_tr">
                ...
                <td>
                    <div class="order_bar" data-ord-id="{{$order->id}}" data-use-id="{{$order->user->id}}">

...
@section('content')
    ...
    <form id="postProduct" class="form__auth">
        ...
        <div class="form-group {{ $errors->has('product_title') ? 'has-error' : '' }}">
            ...
            <input type="text" name="product_title" id="product_title" value="{{ old('product_title') }}" autofocus />
        ...
        <div class="form-group {{ $errors->has('product_price') ? 'has-error' : '' }}">
            ...
            <input type="text" id="product_price" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="product_price" value="{{ old('product_price') }}"/>

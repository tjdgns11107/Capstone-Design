...
@section('content')
    ...
    <form id="postProduct" name="postProduct" class="form__auth">
        {!! csrf_field() !!}

        <div class="form-group {{ $errors->has('product_title') ? 'has-error' : '' }}">
            <label for="product_title">제품 명</label>
            <input type="text" id="product_title" name="product_title" class="form-control" value="{{ old('product_title') }}" autofocus />
        ...
        <div class="form-group {{ $errors->has('product_content') ? 'has-error' : '' }}">
            ...
            <input type="text" id="product_content" name="product_content" class="form-control" value="{{ old('product_content') }}" />

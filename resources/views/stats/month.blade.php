    ...
    <div class="row">
        <div class="col-3 top-div-box-1">
            <div class="card border-success mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-success">
                    <h5 class="card-title">7시간 30분</h5>
        ...
        <div class="col-3 top-div-box-2">
            <div class="card border-success mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body text-success">
                    <h5 class="card-title">2시간 20분</h5>
                    <p class="card-text">프로그레스 바</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-3 top-div-box-3">
            <div class="card border-success mb-3" style="max-width: 18rem;">
                <div class="card-header">한달 동안 가장 많이 취한 자세</div>
                <div class="card-body text-success">
                    <h5 class="card-title">오른쪽다리 꼰 자세</h5>
        ...
        <div class="col-3 right-banner-box">
            <div class="card border-success mb-3" style="max-width: 18rem;">
            <div class="card-header">5월 전체 리포트</div>
                <div class="card-body text-success">
                    <h5 class="card-title">1) 5월의 도전</h5>
                    <p class="card-text">바른자세 챌린지 완주 (달성율 83%)</p>
                    <h5 class="card-title">2) 스트레칭게임 최고 점수 : 1030점</h5>
                    <p class="card-text">랭킹 37위 입니다!</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 main-div-box" style="margin-top:30px;">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">5월 어떤 자세로 앉았을까?</h5>
